...
#         # Added
#         else:
#             logger.info("MegaDepth dataset already exists.")
...
#             with tarfile.open(tar_path) as tar:
#                 tar.extractall(path=tmp_dir)
#                 ###  Log the extracted directories and files
#                 for member in tar.getmembers():
#                     extracted_path = tmp_dir / member.name
#                     if extracted_path.is_dir():
#                         log.write(f"Extracted directory: {extracted_path}\n")
...
#         ###
#         # print(f"Reading image from {path}")  # Add this line to log the path
...
#         if self.conf.read_depth:
#             # print( scene, idx)
#             # print(self.root / self.conf.depth_subpath / scene / (path.stem + ".h5"))
#             depth_path = (
#                 self.root / self.conf.depth_subpath / scene / (path.stem + ".h5")
#             )
#             ### Added
...
#             else:
#                 scene, idx0, idx1, overlap = self.items[idx]
#             # print(f"getitem called with scene: {scene}, idx0: {idx0}, idx1: {idx1}, overlap: {overlap}")  # Add this line
...
#             scene, idx0 = self.items[idx]
#             data = self._read_view(scene, idx0)
#             # print(f"where convf views != 2, getitem called with scene: {scene}, idx0: {idx0}")  # Add this line        
#         data["scene"] = scene
#         data["idx"] = idx
#         return data
